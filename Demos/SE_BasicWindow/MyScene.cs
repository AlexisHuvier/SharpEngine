...
internal class MyScene : Scene
{
    ...
    public MyScene()
    {
        ...
        AddWidget(new ColorRect(new Vec2(400, 400), new Vec2(50), Color.OrangeRed)).ZLayer = 10;
        AddWidget(new Frame(new Vec2(425, 400), new Vec2(50), new Vec2(10), Color.Brown));
